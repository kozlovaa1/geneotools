      ...
      <tbody>
        {rows.map((person) => (
          <tr key={person.id} className={ATDB_TABLE_ROW_CLASS_NAME}>
            ...
            <td className={ATDB_TABLE_CELL_CLASS_NAME}>{person.birthDate || '-'}</td>
            <td className={ATDB_TABLE_CELL_CLASS_NAME}>{person.deathDate || '-'}</td>
            <td className={ATDB_TABLE_CELL_CLASS_NAME}>{editors.renderPlaceLinkEditor(person, 'birthPlaceId', label('birthPlace', 'Место рождения'))}</td>
            <td className={ATDB_TABLE_CELL_CLASS_NAME}>{editors.renderPlaceLinkEditor(person, 'deathPlaceId', label('deathPlace', 'Место смерти'))}</td>
