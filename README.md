...
- **Массовое редактирование** — выбранные строки, все строки вкладки или строки по простому условию можно заполнить, очистить или обработать строковой заменой через предпросмотр
...
4. Изменить разрешённые поля в таблицах
5. При необходимости выбрать строки и применить массовое редактирование после предпросмотра
6. Скачать обновлённый .atdb
```
